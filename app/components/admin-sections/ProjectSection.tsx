...
const ROW_CLASS =
  "transition-colors hover:bg-gray-50 [&:last-child_td]:border-b-0";
...
export default function ProjectSection({
  ...
  const [projects, setProjects] =
    useState<ProjectInput[]>(initialProjects);
  ...
  const [technologiesUsed, setTechnologiesUsed] =
    useState("");

  const [projectLink, setProjectLink] =
    useState("");

  const [repositoryLink, setRepositoryLink] =
    useState("");
  ...
  async function handleSaveEdit(id: string) {
    ...
    try {
      ...
      const payload: ProjectInput = {
        id,
        project_title:
          editForm.project_title,
        project_description:
          editForm.project_description,
        project_image:
          editForm.project_image || null,
        project_type:
          editForm.project_type || null,
        role:
          editForm.role || null,
        technologies_used:
          editForm.technologies_used,
        project_link:
          editForm.project_link || null,
        repository_link:
          editForm.repository_link || null,
        start_date:
        ...
        updated_at:
          new Date(),
        project_status:
          editForm.project_status as project_status,
        is_ongoing:
          editForm.is_ongoing,
        personal_details_id_fk:
          personalDetailsId,
    ...
    >
      ...
      {!personalDetailsId && (
        <p className="text-sm text-gray-500">
          Save your personal details first before
          adding projects.
        </p>
      )}
        ...
        <Cform onSubmit={handleAddProject}>
          ...
          >
            <div>
              ...
              <FieldError
                message={addErrors.project_image}
              />
            </div>
            ...
            <div>
              ...
              <FieldError
                message={addErrors.project_title}
              />
            </div>
            ...
            <div>
              ...
              <FieldError
                message={addErrors.project_type}
              />
            </div>
            ...
            <div>
              ...
              <FieldError
                message={addErrors.project_link}
              />
            </div>
